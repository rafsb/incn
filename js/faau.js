...
String.prototype.check = function(tx=null, flag="gi"){
...
class FAAU {
    ...
    new(node='div', cls="auto-created", style={display:"inline-block"}) {
        return document.createElement(node).addClass(cls).setStyle(style);
    }
...
, tileClickEffectSelector = function(cls=null){
    ...
    $(cls).on("click",function(e){
        ...
        this.app(_.new("span").addClass("-absolute").setStyle({
